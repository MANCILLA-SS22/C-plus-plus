...
bool busqueda(nodo *arbol, int n)
{
	...
	else if(n < arbol->dato)//Si el valor es menor al valor de la raiz, entonces ese valor estara del lado izquierdo, por lo cual debemos verifcartodo el subconjunto izquierdo hasta dar con el numero.
	{
